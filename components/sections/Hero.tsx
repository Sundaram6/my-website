    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden px-6 pt-32 pb-20">
      ...
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        <motion.div
          ...
          className="inline-flex items-center gap-2 glass2 border border-orange-500/30 px-5 py-2 rounded-full text-xs font-semibold text-brand-blue3 mb-8"
        >
        ...
        >
          ...
          <span className="gradient-text">
            {typed}
            <span className="inline-block w-[3px] h-[0.85em] bg-brand-blue2 ml-0.5 align-text-bottom animate-[blink-cursor_0.7s_steps(1)_infinite]" />
          </span>
        </motion.h1>
        ...
        >
          <Link href="#projects"
            className="bg-gradient-to-r from-brand-blue to-brand-purple text-white px-9 py-3.5 rounded-xl font-semibold text-[0.95rem] hover:-translate-y-0.5 hover:shadow-[0_8px_35px_rgba(255,157,102,0.45)] transition-all">
            View My Work
          </Link>
          <Link href="#contact"
            className="glass2 border border-white/8 text-white px-9 py-3.5 rounded-xl font-semibold text-[0.95rem] backdrop-blur-xl hover:border-orange-500/30 hover:-translate-y-0.5 transition-all">
            Let's Talk
          </Link>
        </motion.div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-slate-600 text-xs">
        <span>Scroll</span>
        <div className="w-px h-10 bg-gradient-to-b from-brand-blue to-transparent animate-[scrollLine_1.5s_ease-in-out_infinite]" />
      </div>
    </section>
  );
}
